...
| 7 | - Xây dựng dashboard CloudWatch (EC2, RDS, load balancer) và đẩy application log vào một log group <br> - Cấu hình alarm cho tình trạng sức khỏe (health) của target group và áp lực tài nguyên cơ sở dữ liệu, kết nối tới một SNS topic gửi email <br> - Chủ động kích hoạt một alarm để xác nhận nó thực sự báo động (fire) và gửi thông báo, thay vì tin tưởng nó ở trạng thái OK mà chưa từng kiểm chứng | 25/7 | <https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/> |
