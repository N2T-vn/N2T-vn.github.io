...
\begin{center}
\begin{tabular}{c}
\multicolumn{1}{c}{\textbf{{\LARGE OFF-CAMPUS}}}\\
\\{\textbf{{\LARGE INTERNSHIP REPORT}}}
\\
\\
\textbf{\Large SUMMER SEMESTER, ACADEMIC YEAR 2025-2026} \\
\end{tabular}
\end{center}
\vspace{0.5cm}
\begin{itemize}
\renewcommand\labelitemi{--}
    ...
    \item \Large \textbf{PROGRAM: OISP}
\end{itemize}
\vspace{0.7cm}
\begin{itemize}
\renewcommand\labelitemi{--}
    \item \Large \textbf{HOST COMPANY / ORGANIZATION:}
    \\ \Large \textbf{Amazon Web Services Vietnam Company Limited}
    \item \Large \textbf{INTERNSHIP POSITION: Workforce Bootcamp - First Cloud AI Journey}
    \item \Large \textbf{INTERNSHIP DURATION: 15/06/2026 -- 31/07/2026}
    \item \Large \textbf{INDUSTRY MENTOR:}
    \\ \Large \textbf{Lu Hoan Thien}
    \item \Large \textbf{ACADEMIC SUPERVISOR:}
    \\ \Large \textbf{Nguyen Minh Tam}
    \item \Large \textbf{STUDENT:}
    \\ \Large \textbf{FULL NAME: Nguyen Thanh Tai} \textbf{STUDENT ID: 2353062}
    \\ \Large \textbf{CLASS: CC23KHM5} \quad \textbf{EMAIL: tai.nguyen206k23@hcmut.edu.vn} \quad \textbf{PHONE: 0382630619}
\end{itemize}
\vspace{0.5cm}
\begin{center}
