...
\begin{center}
\fontsize{15}{18}\selectfont
\textbf{HỌC KỲ HÈ 253 NĂM HỌC 2025-2026}
\end{center}
...
\renewcommand\labelitemi{--}
    \item \textbf{NGÀNH: Khoa học Máy tính}
    \item \textbf{CHƯƠNG TRÌNH ĐÀO TẠO: OISP}
\end{itemize}
...
\begin{itemize}
\renewcommand\labelitemi{--}
    \item \textbf{ĐƠN VỊ/ DOANH NGHIỆP NHẬN THỰC TẬP:}
    \\ \textbf{Amazon Web Services Vietnam Company Limited}
    \item \textbf{CÁN BỘ HƯỚNG DẪN CHUYÊN MÔN TRỰC TIẾP CỦA ĐƠN VỊ/ DOANH NGHIỆP:}
    \\ \textbf{Lữ Hoàn Thiện}
    \item \textbf{CÁN BỘ HỖ TRỢ HƯỚNG DẪN/ GIÁM SÁT/ CHẤM ĐIỂM BÁO CÁO CỦA KHOA (CBHT HD/GS/CĐBC):}
    \\ \textbf{Nguyễn Minh Tâm}
    \item \textbf{SINH VIÊN THỰC HIỆN (SVTH):}
    \\ \textbf{HỌ VÀ TÊN: Nguyễn Thành Tài} \quad \textbf{MSSV: 2353062}
\end{itemize}
