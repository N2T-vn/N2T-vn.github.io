...
\\
\\
\textbf{\Large HỌC KỲ HÈ NĂM HỌC 2025-2026} \\
\end{tabular}
\end{center}
\vspace{0.5cm}
\begin{itemize}
\renewcommand\labelitemi{--}
    ...
    \item \Large \textbf{CHƯƠNG TRÌNH ĐÀO TẠO: OISP}
\end{itemize}
\vspace{0.7cm}
\begin{itemize}
\renewcommand\labelitemi{--}
    ...
    \item \Large \textbf{VỊ TRÍ THỰC TẬP: Workforce Bootcamp - First Cloud AI Journey}
    \item \Large \textbf{THỜI GIAN THỰC TẬP: 15/06/2026 -- 31/07/2026}
    ...
    \\ \Large \textbf{Nguyễn Minh Tâm}
    \item \Large \textbf{SINH VIÊN THỰC HIỆN (SVTH):}
    \\ \Large \textbf{HỌ VÀ TÊN: Nguyễn Thành Tài} \textbf{MSSV: 2353062}
    \\ \Large \textbf{LỚP: CC23KHM5} \quad \textbf{EMAIL: tai.nguyen206k23@hcmut.edu.vn} \quad \textbf{SĐT: 0382630619}
\end{itemize}
\vspace{0.5cm}
\begin{center}
